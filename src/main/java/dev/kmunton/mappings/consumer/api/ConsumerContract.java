...
public interface ConsumerContract {
    ...
    ResponseEntity<String> getMarvelHero(@Parameter(name = "attribute1", in= QUERY, required = true, example = "red") String attribute1,
                                         @Parameter(name = "attribute2", in= QUERY, required = false, example = "hammer") String attribute2);
    ...
    ResponseEntity<Void> getNewMappings(@Parameter(name = "key", in= QUERY, required = true, example = "mappings_file_v1_0.csv") String key) throws IOException;
}
